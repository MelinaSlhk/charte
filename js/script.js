...
const div1= document.querySelector(".reussite-collective")
...
div1.addEventListener("click",(e)=> {
    isVisible1 = !isVisible1;
        ...
        if (isVisible1){
            ...
            } else{ul.classList.remove("paragraphe1bis")}
...
const div2= document.querySelector(".vivre-ensemble")

div2.addEventListener("click", (e)=> {
    isVisible2 = !isVisible2;
        if (isVisible2){
            partie2.classList.add("paragraphe2bis")
            } else{partie2.classList.remove("paragraphe2bis")}
})

let isVisible3 = false
const partie3= document.querySelector(".paragraphe3")

const div3= document.querySelector(".dernier")

div3.addEventListener("click", (e)=> {
    isVisible3 = !isVisible3;
        if (isVisible3){
            partie3.classList.add("paragraphe3bis")
        } else{partie3.classList.remove("paragraphe3bis")}
})
